...
import type { ConsumableEquipSlot, ContentId, EntityId, EquipSlot, SpellEquipSlot } from '../sim/types';
...
export interface PlayerIntentFacet {
  ...
  equipConsumable(slot: ConsumableEquipSlot, itemId: ContentId): boolean;
