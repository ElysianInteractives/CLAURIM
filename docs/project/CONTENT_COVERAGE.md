...
| Asset pipeline | AUTHORING_READY | bounded high/medium code-native exemplars and the three Falkmoor GLB pilots ship live; D-050 supplies the Blender constitution and source/export gate; D-052 supplies the cached Meshopt/KTX2-ready runtime catalog, LOD, hot reload, and procedural fallback; D-053 supplies the installed no-code Blender world importer, manifest palette, validators, proposal exporter, and committed five-space scene; commissioned assets and live location/terrain migration remain future work |
