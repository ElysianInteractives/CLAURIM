...
| Caves/mines | interior spaces | DONE (1) | Duskhollow Mine | ~30 | none (rooms+corridors proven) | yes | light | nav test per dungeon |
...
| Perk trees | perks | SYSTEM | 5 perks, prereq chain | ~150 perks | only perks needing NEW hooks | template perks | yes | validation tests |
...
| Weapons | items | SYSTEM | 4 | ~80 | new weapon CLASSES (2H, crossbow timing) | tier fills | no | validation |
| Armor | items | SYSTEM | 4 | ~60 | armor-class perks interplay | tier fills | no | validation |
...
| Loot tables/economy | loot | SYSTEM | 6 tables | full economy | price/scarcity model | tables | no | validation |
...
| Creatures | ai | SYSTEM | wolf/rat/wight | ~30 | new locomotion modes (fly/swim/burrow) | melee/ranged variants | light | combat tests |
